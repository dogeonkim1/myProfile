...
import { FaCss3Alt, FaGithub, FaHtml5, FaJava, FaNodeJs, FaReact, FaWindows } from "react-icons/fa";
...
const categories = [
  {
    title: "OS",
    bgLabel: "-OS-",
    skills: [{ icon: <FaWindows size={35} className="text-blue-500" />, label: "Windows" }],
  },
  {
    title: "Web",
    bgLabel: "-Web-",
